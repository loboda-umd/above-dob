...
try:
    for year in range(2016, 2017):
        ...
        afpath = direct + 'Final\\Output\\' + str(year) + '\\fires_cl_split\\'
        medpath = direct + 'Final\\Output\\' + str(year) +'\\fires_cl_split_medpath\\'
        ...
        for afi in range(1, 1178): #1401 for 2012; 1529 for 2013; 1141 for 2014; 2093 for 2015; 1178 for 2016 ; 1720 for 2017; 1956 for 2018; 1189 for 2019
            ...
            if os.path.exists(origFire):
                ...
                # YYYYMMDD, HHMM, LAT, LON, TARGET_FID (This helps identify the original fires from the primary and residual fires in the AF post processing)
